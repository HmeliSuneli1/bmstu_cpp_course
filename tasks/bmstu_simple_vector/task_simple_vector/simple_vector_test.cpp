...
{
    {
        ASSERT_TRUE((bmstu::simple_vector{1, 2, 3} == bmstu::simple_vector{1, 2, 3}));
        ASSERT_TRUE((bmstu::simple_vector{1, 2, 3} != bmstu::simple_vector{1, 2, 2}));

        ASSERT_TRUE((bmstu::simple_vector{1, 2, 3} < bmstu::simple_vector{1, 2, 3, 1}));
        ASSERT_TRUE((bmstu::simple_vector{1, 2, 3} > bmstu::simple_vector{1, 2, 2, 1}));

        ASSERT_TRUE((bmstu::simple_vector{1, 2, 3} >= bmstu::simple_vector{1, 2, 3}));
        ASSERT_TRUE((bmstu::simple_vector{1, 2, 4} >= bmstu::simple_vector{1, 2, 3}));
        ASSERT_TRUE((bmstu::simple_vector{1, 2, 3} <= bmstu::simple_vector{1, 2, 3}));
        ASSERT_TRUE((bmstu::simple_vector{1, 2, 3} <= bmstu::simple_vector{1, 2, 4}));
    }
}
